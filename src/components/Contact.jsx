...
export const Contact = () => {
  ...
  const getEmail = () => {
    try {
      const userData = JSON.parse(localStorage.getItem('user'));
      return userData.result.user.email;
    } catch (error) {
      console.error('Error retrieving user data from localStorage:', error);
      return '';
    }
      ...
      <div className="mx-auto w-full max-w-7xl bg-white text-gray-700">
        <div className="grid grid-cols-2">
          ...
          <div className="order-3 md:order-2 col-span-full md:col-span-1 py-5 md:py-10 px-6">
            <form action="" className="mx-auto max-w-xl space-y-4" ref={form} onSubmit={sendEmail}>
              {/* Name Input */}
              <div>
                <label htmlFor="name" className="sr-only">Name</label>
                <input
                  ref={nameRef} type="text" id="name" name="from_name"
                  placeholder="Name"
                  value={userName}
              ...
              <div>
                ...
                <input
                  ref={emailRef} type="email" id="email" name="from_email"
              ...
              <div className="col-span-full">
                ...
                <textarea
                  ref={messageRef} name="message" id="message" cols="30" rows="4"
          ...
          <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
            <div className="mx-auto max-w-xl flex flex-col space-y-5">
              ...
              <div className="flex items-center">
                {/* Twitter */}
                <NavLink to={"#twitter"} className="m-1.5 w-8 h-8 inline-flex justify-center items-center shadow-sm rounded-full bg-[#1DA1F2] text-white filter hover:brightness-125" style={{ backgroundColor: "#1DA1F2" }}>
                ...
                {/* FACEBOOK */}
                <NavLink to={"#facebook"} className="m-1.5 w-8 h-8 inline-flex justify-center items-center shadow-sm rounded-full bg-[#4267B2] text-white filter hover:brightness-125" style={{ backgroundColor: "#4267B2" }}>
                ...
                {/* Instagram */}
                <NavLink to={"#instagrap"} className="m-1.5 w-8 h-8 inline-flex justify-center items-center shadow-sm rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white filter hover:brightness-125">
                  <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
